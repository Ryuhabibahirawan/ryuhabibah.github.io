...
```         
Call: lm(formula = Y ~ X, data = metopel2)  Residuals:       Min        1Q    Median        3Q       Max  -58566245 -25591098   1566664  10369872 152032257   Coefficients:              Estimate Std. Error t value Pr(>|t|)   (Intercept) 131367371   60319936   2.178   0.0484 * X              -10297       5177  -1.989   0.0682 . --- Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1  Residual standard error: 49850000 on 13 degrees of freedom Multiple R-squared:  0.2333,	Adjusted R-squared:  0.1743  F-statistic: 3.955 on 1 and 13 DF,  p-value: 0.0682
```
...
Syam, S. (2019). Strategi Bauran Pemasaran Rumput Laut Gracillaria pada CV Simpul Agro Globalindo Makassar. BRAND Jurnal Ilmiah Manajemen Pemasaran, 1(2). 

Bu'ulolo, Y. E. (2022). Analisis Pengaruh Ekspor, Impor dan Investasi Terhadap Pertumbuhan Ekonomi Indonesia Tahun 2005-2019.

DEWI, Y. F. (2020). PELAYANAN EKSPEDISI MUATAN KAPAL LAUT DALAM MELAKSANAKAN KEGIATAN IMPOR GARMENT DI PT. KONESIA PROLOGIX LINE CABANG SEMARANG. KARYA TULIS.
